...
public class App {
    ...
    public static void main(String[] args) {
        ...
        apply(input, dithering.ordered().bayer2x2(), "bayer-2");
        apply(color, dithering.ordered().bayer2x2(), "bayer-2-color");

        apply(input, dithering.ordered().bayer4x4(), "bayer-4");
        apply(color, dithering.ordered().bayer4x4(), "bayer-4-color");

        apply(input, dithering.ordered().bayer8x8(), "bayer-8");
    ...
    private static String output(final String name) {
        return EXAMPLE.replace(NAME, name + "-operation");
    }
}
